...
// Hash: bb0234f806f5f4731e612673b47f1706cc3aad78a35a92eeb3b0236c9ac3262e
package v1
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = a.Data.UnmarshalSSZ(buf[4:396]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(a.Signature) == 0 {
		a.Signature = make([]byte, 0, len(buf[396:492]))
	}
	a.Signature = append(a.Signature, buf[396:492]...)
...
func (a *AttestationData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if a.TimelockPublickey == nil {
		a.TimelockPublickey = new(RSAPublicKey)
	}
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	if err = a.TimelockPublickey.UnmarshalSSZ(buf[128:392]); err != nil {
		return err
	}
...
func (i *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = i.Data.UnmarshalSSZ(buf[4:396]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(i.Signature) == 0 {
		i.Signature = make([]byte, 0, len(buf[396:492]))
	}
	i.Signature = append(i.Signature, buf[396:492]...)
