...
// Hash: 7ce076dc9a3c65964cb8d3020bce1c801ed31658b23a3f13f619a8317bf8c911
package v1
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = a.Data.UnmarshalSSZ(buf[4:1668]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(a.Signature) == 0 {
		a.Signature = make([]byte, 0, len(buf[1668:1764]))
	}
	a.Signature = append(a.Signature, buf[1668:1764]...)
...
func (a *AttestationData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (5) 'TimelockPublickey'
	if a.TimelockPublickey == nil {
		a.TimelockPublickey = new(ElgamalPublicKey)
	}
	if dst, err = a.TimelockPublickey.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	if err = a.TimelockPublickey.UnmarshalSSZ(buf[128:1664]); err != nil {
		return err
	}
...
func (a *AttestationData) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (5) 'TimelockPublickey'
	if err = a.TimelockPublickey.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (i *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = i.Data.UnmarshalSSZ(buf[4:1668]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(i.Signature) == 0 {
		i.Signature = make([]byte, 0, len(buf[1668:1764]))
	}
	i.Signature = append(i.Signature, buf[1668:1764]...)
