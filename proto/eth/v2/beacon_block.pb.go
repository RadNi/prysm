...
type BeaconBlockBodyBellatrix struct {
	...
	TimelockPrivatekey *v11.ElgamalPrivateKey    `protobuf:"bytes,11,opt,name=timelock_privatekey,json=timelockPrivatekey,proto3" json:"timelock_privatekey,omitempty"`
	TimelockPuzzle     *v1.TimelockPuzzle        `protobuf:"bytes,12,opt,name=timelock_puzzle,json=timelockPuzzle,proto3" json:"timelock_puzzle,omitempty"`
}
...
func (x *BeaconBlockBodyBellatrix) GetTimelockPrivatekey() *v11.ElgamalPrivateKey {
	if x != nil {
...
func (x *BeaconBlockBodyBellatrix) GetTimelockPuzzle() *v1.TimelockPuzzle {
	if x != nil {
...
var file_proto_eth_v2_beacon_block_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0xf2, 0x06, 0x0a, 0x18, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63,
	...
	0x6c, 0x6f, 0x61, 0x64, 0x12, 0x56, 0x0a, 0x13, 0x74, 0x69, 0x6d, 0x65, 0x6c, 0x6f, 0x63, 0x6b,
	0x5f, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x6b, 0x65, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28,
	...
	0x63, 0x6b, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x6b, 0x65, 0x79, 0x12, 0x48, 0x0a, 0x0f,
	0x74, 0x69, 0x6d, 0x65, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x70, 0x75, 0x7a, 0x7a, 0x6c, 0x65, 0x18,
	0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d,
	0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x6c, 0x6f, 0x63, 0x6b,
	0x50, 0x75, 0x7a, 0x7a, 0x6c, 0x65, 0x52, 0x0e, 0x74, 0x69, 0x6d, 0x65, 0x6c, 0x6f, 0x63, 0x6b,
	0x50, 0x75, 0x7a, 0x7a, 0x6c, 0x65, 0x22, 0xea, 0x05, 0x0a, 0x1f, 0x42, 0x6c, 0x69, 0x6e, 0x64,
	...
	0x64, 0x65, 0x72, 0x22, 0xfa, 0x04, 0x0a, 0x15, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c,
	...
	0x33, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x65, 0x74, 0x68, 0x2f, 0x76, 0x32, 0x3b, 0x65,
...
var file_proto_eth_v2_beacon_block_proto_goTypes = []interface{}{
	...
	(*v11.ElgamalPrivateKey)(nil),             // 26: ethereum.engine.v1.ElgamalPrivateKey
	(*v1.TimelockPuzzle)(nil),                 // 27: ethereum.eth.v1.TimelockPuzzle
	(*v11.ExecutionPayloadHeader)(nil),        // 28: ethereum.engine.v1.ExecutionPayloadHeader
}
var file_proto_eth_v2_beacon_block_proto_depIdxs = []int32{
	...
	26, // 30: ethereum.eth.v2.BeaconBlockBodyBellatrix.timelock_privatekey:type_name -> ethereum.engine.v1.ElgamalPrivateKey
	27, // 31: ethereum.eth.v2.BeaconBlockBodyBellatrix.timelock_puzzle:type_name -> ethereum.eth.v1.TimelockPuzzle
	18, // 32: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	19, // 33: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	20, // 34: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	21, // 35: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1.Attestation
	22, // 36: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.deposits:type_name -> ethereum.eth.v1.Deposit
	23, // 37: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	24, // 38: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	28, // 39: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	18, // 40: ethereum.eth.v2.BeaconBlockBodyAltair.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	19, // 41: ethereum.eth.v2.BeaconBlockBodyAltair.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	20, // 42: ethereum.eth.v2.BeaconBlockBodyAltair.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	21, // 43: ethereum.eth.v2.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1.Attestation
	22, // 44: ethereum.eth.v2.BeaconBlockBodyAltair.deposits:type_name -> ethereum.eth.v1.Deposit
	23, // 45: ethereum.eth.v2.BeaconBlockBodyAltair.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	24, // 46: ethereum.eth.v2.BeaconBlockBodyAltair.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
