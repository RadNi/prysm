...
type BeaconBlockBodyBellatrix struct {
	...
	TimelockPrivatekey *v11.RSAPrivateKey        `protobuf:"bytes,11,opt,name=timelock_privatekey,json=timelockPrivatekey,proto3" json:"timelock_privatekey,omitempty"`
}
...
func (x *BeaconBlockBodyBellatrix) GetTimelockPrivatekey() *v11.RSAPrivateKey {
	if x != nil {
...
var file_proto_eth_v2_beacon_block_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0xa4, 0x06, 0x0a, 0x18, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63,
	...
	0x6c, 0x6f, 0x61, 0x64, 0x12, 0x52, 0x0a, 0x13, 0x74, 0x69, 0x6d, 0x65, 0x6c, 0x6f, 0x63, 0x6b,
	...
	0x69, 0x76, 0x61, 0x74, 0x65, 0x6b, 0x65, 0x79, 0x22, 0xea, 0x05, 0x0a, 0x1f, 0x42, 0x6c, 0x69,
	0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42,
	...
	0x74, 0x65, 0x42, 0x83, 0x01, 0x0a, 0x13, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
...
var file_proto_eth_v2_beacon_block_proto_goTypes = []interface{}{
	...
	(*v11.RSAPrivateKey)(nil),                 // 26: ethereum.engine.v1.RSAPrivateKey
...
var file_proto_eth_v2_beacon_block_proto_depIdxs = []int32{
	...
	26, // 30: ethereum.eth.v2.BeaconBlockBodyBellatrix.timelock_privatekey:type_name -> ethereum.engine.v1.RSAPrivateKey
	18, // 31: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	19, // 32: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	20, // 33: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	21, // 34: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1.Attestation
	22, // 35: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.deposits:type_name -> ethereum.eth.v1.Deposit
	23, // 36: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	24, // 37: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	27, // 38: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	18, // 39: ethereum.eth.v2.BeaconBlockBodyAltair.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	19, // 40: ethereum.eth.v2.BeaconBlockBodyAltair.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	20, // 41: ethereum.eth.v2.BeaconBlockBodyAltair.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	21, // 42: ethereum.eth.v2.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1.Attestation
	22, // 43: ethereum.eth.v2.BeaconBlockBodyAltair.deposits:type_name -> ethereum.eth.v1.Deposit
	23, // 44: ethereum.eth.v2.BeaconBlockBodyAltair.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	24, // 45: ethereum.eth.v2.BeaconBlockBodyAltair.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
