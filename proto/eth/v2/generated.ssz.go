...
// Hash: 9088bc8fa7f218d0fa3fe5125a11cfa190ffb656848c0644b23278c1dae7d0d7
package eth
...
func (b *BeaconBlockBodyBellatrix) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.TimelockPrivatekey == nil {
		b.TimelockPrivatekey = new(v11.ElgamalPrivateKey)
	}
	...
	if b.TimelockPuzzle == nil {
		b.TimelockPuzzle = new(v1.TimelockPuzzle)
	}
