...
// Hash: 6cc756056c6ca9f67a10610a1c2c7f141dbc8321ac43da6b9f20f958853f62e0
package eth
...
// MarshalSSZ ssz marshals the TimelockPuzzle object
func (t *TimelockPuzzle) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(t)
}

// MarshalSSZTo ssz marshals the TimelockPuzzle object to a target array
func (t *TimelockPuzzle) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'N'
	if size := len(t.N); size != 512 {
		err = ssz.ErrBytesLengthFn("--.N", size, 512)
		return
	}
	dst = append(dst, t.N...)

	// Field (1) 'G'
	if size := len(t.G); size != 512 {
		err = ssz.ErrBytesLengthFn("--.G", size, 512)
		return
	}
	dst = append(dst, t.G...)

	// Field (2) 'T'
	if size := len(t.T); size != 8 {
		err = ssz.ErrBytesLengthFn("--.T", size, 8)
		return
	}
	dst = append(dst, t.T...)

	// Field (3) 'H'
	if size := len(t.H); size != 512 {
		err = ssz.ErrBytesLengthFn("--.H", size, 512)
		return
	}
	dst = append(dst, t.H...)

	// Field (4) 'U'
	if size := len(t.U); size != 512 {
		err = ssz.ErrBytesLengthFn("--.U", size, 512)
		return
	}
	dst = append(dst, t.U...)

	// Field (5) 'V'
	if size := len(t.V); size != 262144 {
		err = ssz.ErrBytesLengthFn("--.V", size, 262144)
		return
	}
	dst = append(dst, t.V...)

	// Field (6) 'Y'
	if size := len(t.Y); size != 512 {
		err = ssz.ErrBytesLengthFn("--.Y", size, 512)
		return
	}
	dst = append(dst, t.Y...)

	// Field (7) 'W'
	if size := len(t.W); size != 262144 {
		err = ssz.ErrBytesLengthFn("--.W", size, 262144)
		return
	}
	dst = append(dst, t.W...)

	// Field (8) 'A'
	if size := len(t.A); size != 512 {
		err = ssz.ErrBytesLengthFn("--.A", size, 512)
		return
	}
	dst = append(dst, t.A...)

	// Field (9) 'B'
	if size := len(t.B); size != 262144 {
		err = ssz.ErrBytesLengthFn("--.B", size, 262144)
		return
	}
	dst = append(dst, t.B...)

	// Field (10) 'Alpha'
	if size := len(t.Alpha); size != 589824 {
		err = ssz.ErrBytesLengthFn("--.Alpha", size, 589824)
		return
	}
	dst = append(dst, t.Alpha...)

	// Field (11) 'Beta'
	if size := len(t.Beta); size != 393216 {
		err = ssz.ErrBytesLengthFn("--.Beta", size, 393216)
		return
	}
	dst = append(dst, t.Beta...)

	// Field (12) 'Tau'
	if size := len(t.Tau); size != 512 {
		err = ssz.ErrBytesLengthFn("--.Tau", size, 512)
		return
	}
	dst = append(dst, t.Tau...)

	return
}

// UnmarshalSSZ ssz unmarshals the TimelockPuzzle object
func (t *TimelockPuzzle) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 1773064 {
		return ssz.ErrSize
	...
	// Field (0) 'N'
	if cap(t.N) == 0 {
		t.N = make([]byte, 0, len(buf[0:512]))
	}
	t.N = append(t.N, buf[0:512]...)

	// Field (1) 'G'
	if cap(t.G) == 0 {
		t.G = make([]byte, 0, len(buf[512:1024]))
	}
	t.G = append(t.G, buf[512:1024]...)

	// Field (2) 'T'
	if cap(t.T) == 0 {
		t.T = make([]byte, 0, len(buf[1024:1032]))
	}
	t.T = append(t.T, buf[1024:1032]...)

	// Field (3) 'H'
	if cap(t.H) == 0 {
		t.H = make([]byte, 0, len(buf[1032:1544]))
	}
	t.H = append(t.H, buf[1032:1544]...)

	// Field (4) 'U'
	if cap(t.U) == 0 {
		t.U = make([]byte, 0, len(buf[1544:2056]))
	}
	t.U = append(t.U, buf[1544:2056]...)

	// Field (5) 'V'
	if cap(t.V) == 0 {
		t.V = make([]byte, 0, len(buf[2056:264200]))
	}
	t.V = append(t.V, buf[2056:264200]...)

	// Field (6) 'Y'
	if cap(t.Y) == 0 {
		t.Y = make([]byte, 0, len(buf[264200:264712]))
	}
	t.Y = append(t.Y, buf[264200:264712]...)

	// Field (7) 'W'
	if cap(t.W) == 0 {
		t.W = make([]byte, 0, len(buf[264712:526856]))
	}
	t.W = append(t.W, buf[264712:526856]...)

	// Field (8) 'A'
	if cap(t.A) == 0 {
		t.A = make([]byte, 0, len(buf[526856:527368]))
	}
	t.A = append(t.A, buf[526856:527368]...)

	// Field (9) 'B'
	if cap(t.B) == 0 {
		t.B = make([]byte, 0, len(buf[527368:789512]))
	}
	t.B = append(t.B, buf[527368:789512]...)

	// Field (10) 'Alpha'
	if cap(t.Alpha) == 0 {
		t.Alpha = make([]byte, 0, len(buf[789512:1379336]))
	}
	t.Alpha = append(t.Alpha, buf[789512:1379336]...)

	// Field (11) 'Beta'
	if cap(t.Beta) == 0 {
		t.Beta = make([]byte, 0, len(buf[1379336:1772552]))
	}
	t.Beta = append(t.Beta, buf[1379336:1772552]...)

	// Field (12) 'Tau'
	if cap(t.Tau) == 0 {
		t.Tau = make([]byte, 0, len(buf[1772552:1773064]))
	}
	t.Tau = append(t.Tau, buf[1772552:1773064]...)

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the TimelockPuzzle object
func (t *TimelockPuzzle) SizeSSZ() (size int) {
	size = 1773064
	return
}

// HashTreeRoot ssz hashes the TimelockPuzzle object
func (t *TimelockPuzzle) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(t)
}

// HashTreeRootWith ssz hashes the TimelockPuzzle object with a hasher
func (t *TimelockPuzzle) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = a.Data.UnmarshalSSZ(buf[4:1773196]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(a.Signature) == 0 {
		a.Signature = make([]byte, 0, len(buf[1773196:1773292]))
	}
	a.Signature = append(a.Signature, buf[1773196:1773292]...)
...
func (a *AttestationData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (5) 'TimelockPuzzle'
	if a.TimelockPuzzle == nil {
		a.TimelockPuzzle = new(TimelockPuzzle)
	}
	if dst, err = a.TimelockPuzzle.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	if err = a.TimelockPuzzle.UnmarshalSSZ(buf[128:1773192]); err != nil {
		return err
	}
...
func (a *AttestationData) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (5) 'TimelockPuzzle'
	if err = a.TimelockPuzzle.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (i *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = i.Data.UnmarshalSSZ(buf[4:1773196]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(i.Signature) == 0 {
		i.Signature = make([]byte, 0, len(buf[1773196:1773292]))
	}
	i.Signature = append(i.Signature, buf[1773196:1773292]...)
...
func (b *BeaconBlockBodyBellatrix) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (10) 'TimelockPrivatekey'
	if b.TimelockPrivatekey == nil {
		b.TimelockPrivatekey = new(v1.ElgamalPrivateKey)
	}
	if dst, err = b.TimelockPrivatekey.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (11) 'TimelockPuzzle'
	if b.TimelockPuzzle == nil {
		b.TimelockPuzzle = new(TimelockPuzzle)
	}
	if dst, err = b.TimelockPuzzle.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (b *BeaconBlockBodyBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.TimelockPrivatekey.UnmarshalSSZ(buf[384:2432]); err != nil {
		return err
	}
	...
	if err = b.TimelockPuzzle.UnmarshalSSZ(buf[2432:1775496]); err != nil {
		return err
	}
...
func (b *BeaconBlockBodyBellatrix) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (10) 'TimelockPrivatekey'
	if err = b.TimelockPrivatekey.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (11) 'TimelockPuzzle'
	if err = b.TimelockPuzzle.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = p.Data.UnmarshalSSZ(buf[4:1773196]); err != nil {
		return err
	}

	// Field (2) 'InclusionDelay'
	p.InclusionDelay = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[1773196:1773204]))

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[1773204:1773212]))
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.TimelockPrivatekey.UnmarshalSSZ(buf[2736633:2738681]); err != nil {
		return err
	}
	...
	if err = b.TimelockPuzzle.UnmarshalSSZ(buf[2738681:4511745]); err != nil {
		return err
	}
