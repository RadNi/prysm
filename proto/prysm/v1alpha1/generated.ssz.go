...
// Hash: 570a771bdb02fd24b47d32d1bd83e238048b4e8d0ec3c2b09799fea17826f725
package eth
...
func (a *AttestationData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if a.TimelockPublickey == nil {
		a.TimelockPublickey = new(v1.ElgamalPublicKey)
	}
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = p.Data.UnmarshalSSZ(buf[4:1668]); err != nil {
		return err
	}

	// Field (2) 'InclusionDelay'
	p.InclusionDelay = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[1668:1676]))

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[1676:1684]))
