...
// Hash: ec5455c20c4c739591a859c85b2ba346ca55128543700a7a905117b00edd5c7f
package eth
...
func (t *TimelockPuzzle) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (8) 'Alpha'
	if size := len(t.Alpha); size != 66048 {
		err = ssz.ErrBytesLengthFn("--.Alpha", size, 66048)
		return
	}
	dst = append(dst, t.Alpha...)

	// Field (9) 'Beta'
	if size := len(t.Beta); size != 512 {
		err = ssz.ErrBytesLengthFn("--.Beta", size, 512)
		return
	}
...
func (t *TimelockPuzzle) UnmarshalSSZ(buf []byte) error {
	...
	// Field (6) 'A'
	if cap(t.A) == 0 {
		t.A = make([]byte, 0, len(buf[264200:264712]))
	}
	t.A = append(t.A, buf[264200:264712]...)

	// Field (7) 'B'
	if cap(t.B) == 0 {
		t.B = make([]byte, 0, len(buf[264712:526856]))
	}
	t.B = append(t.B, buf[264712:526856]...)

	// Field (8) 'Alpha'
	if cap(t.Alpha) == 0 {
		t.Alpha = make([]byte, 0, len(buf[526856:592904]))
	}
	t.Alpha = append(t.Alpha, buf[526856:592904]...)

	// Field (9) 'Beta'
	if cap(t.Beta) == 0 {
		t.Beta = make([]byte, 0, len(buf[592904:593416]))
	}
	t.Beta = append(t.Beta, buf[592904:593416]...)

	// Field (10) 'Tau'
	if cap(t.Tau) == 0 {
		t.Tau = make([]byte, 0, len(buf[593416:593928]))
	}
	t.Tau = append(t.Tau, buf[593416:593928]...)
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = a.Data.UnmarshalSSZ(buf[4:594060]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(a.Signature) == 0 {
		a.Signature = make([]byte, 0, len(buf[594060:594156]))
	}
	a.Signature = append(a.Signature, buf[594060:594156]...)
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	if err = a.TimelockPuzzle.UnmarshalSSZ(buf[128:594056]); err != nil {
		return err
	}
...
func (i *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = i.Data.UnmarshalSSZ(buf[4:594060]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(i.Signature) == 0 {
		i.Signature = make([]byte, 0, len(buf[594060:594156]))
	}
	i.Signature = append(i.Signature, buf[594060:594156]...)
...
func (b *BeaconBlockBodyBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.TimelockPuzzle.UnmarshalSSZ(buf[2432:596360]); err != nil {
		return err
	}
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = p.Data.UnmarshalSSZ(buf[4:594060]); err != nil {
		return err
	}

	// Field (2) 'InclusionDelay'
	p.InclusionDelay = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[594060:594068]))

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[594068:594076]))
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.TimelockPuzzle.UnmarshalSSZ(buf[2738681:3332609]); err != nil {
		return err
	}
