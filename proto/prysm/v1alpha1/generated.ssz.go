...
// Hash: 5eadd4e83cbef822cc85f0a45264c9bf8eeb23bfd35a111f7c4bf35621647694
package eth
...
func (a *AttestationData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if a.TimelockPublickey == nil {
		a.TimelockPublickey = new(v1.RSAPublicKey)
	}
...
func (b *BeaconBlockBodyBellatrix) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (10) 'TimelockPrivatekey'
	dst = ssz.WriteOffset(dst, offset)
	if b.TimelockPrivatekey == nil {
		b.TimelockPrivatekey = new(v1.RSAPrivateKey)
	}
	offset += b.TimelockPrivatekey.SizeSSZ()
...
func (b *BeaconBlockBodyBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	// Field (10) 'TimelockPrivatekey'
	{
		...
		if err = b.TimelockPrivatekey.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
func (b *BeaconBlockBodyBellatrix) SizeSSZ() (size int) {
	...
	size += b.TimelockPrivatekey.SizeSSZ()
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = p.Data.UnmarshalSSZ(buf[4:396]); err != nil {
		return err
	}

	// Field (2) 'InclusionDelay'
	p.InclusionDelay = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[396:404]))

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[404:412]))
