...
type BeaconStateBellatrix struct {
	...
	TimelockPrivatekey           *v1.ElgamalPrivateKey                                             `protobuf:"bytes,11001,opt,name=timelock_privatekey,json=timelockPrivatekey,proto3" json:"timelock_privatekey,omitempty"`
	TimelockPuzzle               *TimelockPuzzle                                                   `protobuf:"bytes,11002,opt,name=timelock_puzzle,json=timelockPuzzle,proto3" json:"timelock_puzzle,omitempty"`
}
...
func (x *BeaconStateBellatrix) GetTimelockPrivatekey() *v1.ElgamalPrivateKey {
	if x != nil {
...
func (x *BeaconStateBellatrix) GetTimelockPuzzle() *TimelockPuzzle {
	if x != nil {
...
var file_proto_prysm_v1alpha1_beacon_state_proto_rawDesc = []byte{
	...
	0xf3, 0x0f, 0x0a, 0x14, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42,
	...
	,
	...
	0x6c, 0x61, 0x73, 0x74, 0x5f, 0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x5f,
	...
	0x6f, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x1c, 0x6c, 0x61, 0x73, 0x74, 0x57, 0x69, 0x74,
...
var file_proto_prysm_v1alpha1_beacon_state_proto_goTypes = []interface{}{
	...
	(*v1.ElgamalPrivateKey)(nil),             // 21: ethereum.engine.v1.ElgamalPrivateKey
	(*TimelockPuzzle)(nil),                   // 22: ethereum.eth.v1alpha1.TimelockPuzzle
...
var file_proto_prysm_v1alpha1_beacon_state_proto_depIdxs = []int32{
	...
	21, // 33: ethereum.eth.v1alpha1.BeaconStateBellatrix.timelock_privatekey:type_name -> ethereum.engine.v1.ElgamalPrivateKey
	22, // 34: ethereum.eth.v1alpha1.BeaconStateBellatrix.timelock_puzzle:type_name -> ethereum.eth.v1alpha1.TimelockPuzzle
	2,  // 35: ethereum.eth.v1alpha1.BeaconStateCapella.fork:type_name -> ethereum.eth.v1alpha1.Fork
	15, // 36: ethereum.eth.v1alpha1.BeaconStateCapella.latest_block_header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	16, // 37: ethereum.eth.v1alpha1.BeaconStateCapella.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	16, // 38: ethereum.eth.v1alpha1.BeaconStateCapella.eth1_data_votes:type_name -> ethereum.eth.v1alpha1.Eth1Data
	17, // 39: ethereum.eth.v1alpha1.BeaconStateCapella.validators:type_name -> ethereum.eth.v1alpha1.Validator
	18, // 40: ethereum.eth.v1alpha1.BeaconStateCapella.previous_justified_checkpoint:type_name -> ethereum.eth.v1alpha1.Checkpoint
	18, // 41: ethereum.eth.v1alpha1.BeaconStateCapella.current_justified_checkpoint:type_name -> ethereum.eth.v1alpha1.Checkpoint
	18, // 42: ethereum.eth.v1alpha1.BeaconStateCapella.finalized_checkpoint:type_name -> ethereum.eth.v1alpha1.Checkpoint
	10, // 43: ethereum.eth.v1alpha1.BeaconStateCapella.current_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	10, // 44: ethereum.eth.v1alpha1.BeaconStateCapella.next_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	23, // 45: ethereum.eth.v1alpha1.BeaconStateCapella.latest_execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
