...
func V1Alpha1AttDataToV1(v1alpha1AttData *ethpbalpha.AttestationData) *ethpbv1.AttestationData {
	...
	return &ethpbv1.AttestationData{
		...
		TimelockPuzzle: &ethpbv1.TimelockPuzzle{
			...
			Y:     v1alpha1AttData.TimelockPuzzle.Y,
			W:     v1alpha1AttData.TimelockPuzzle.W,
...
func V1AttDataToV1Alpha1(v1AttData *ethpbv1.AttestationData) *ethpbalpha.AttestationData {
	...
	return &ethpbalpha.AttestationData{
		...
		TimelockPuzzle: &ethpbalpha.TimelockPuzzle{
			...
			Y:     v1AttData.TimelockPuzzle.Y,
			W:     v1AttData.TimelockPuzzle.W,
		...
		resultCurrEpochAtts[i] = &ethpbv1.PendingAttestation{
			...
			Data: &ethpbv1.AttestationData{
				...
				TimelockPuzzle: &ethpbv1.TimelockPuzzle{
					...
					U:     data.TimelockPuzzle.U,
					V:     data.TimelockPuzzle.V,
					Y:     data.TimelockPuzzle.Y,
					W:     data.TimelockPuzzle.W,
					A:     data.TimelockPuzzle.A,
					B:     data.TimelockPuzzle.B,
					Alpha: data.TimelockPuzzle.Alpha,
					Beta:  data.TimelockPuzzle.Beta,
