...
// Hash: 09b3ec1c249b8ea2eb8dc35fdd75e2d7624e00521ffdd53441d125ee640764a4
package enginev1
...
func (e *ExecutionPayload) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (14) 'TimelockPrivatekey'
	if e.TimelockPrivatekey == nil {
		e.TimelockPrivatekey = new(ElgamalPrivateKey)
	}
	if dst, err = e.TimelockPrivatekey.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (15) 'TimelockPublickey'
	if e.TimelockPublickey == nil {
		e.TimelockPublickey = new(ElgamalPublicKey)
	}
	if dst, err = e.TimelockPublickey.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (e *ExecutionPayload) UnmarshalSSZ(buf []byte) error {
	...
	if err = e.TimelockPrivatekey.UnmarshalSSZ(buf[508:2556]); err != nil {
		return err
	}
	...
	if err = e.TimelockPublickey.UnmarshalSSZ(buf[2556:4092]); err != nil {
		return err
	}
...
func (e *ExecutionPayload) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (14) 'TimelockPrivatekey'
	if err = e.TimelockPrivatekey.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (15) 'TimelockPublickey'
	if err = e.TimelockPublickey.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (e *ExecutionPayloadHeader) UnmarshalSSZ(buf []byte) error {
	...
	if err = e.TimelockPrivatekey.UnmarshalSSZ(buf[536:2584]); err != nil {
		return err
	}
	...
	if err = e.TimelockPublickey.UnmarshalSSZ(buf[2584:4120]); err != nil {
		return err
	}
...
// MarshalSSZ ssz marshals the ElgamalPublicKey object
func (e *ElgamalPublicKey) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ElgamalPublicKey object to a target array
func (e *ElgamalPublicKey) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'G'
	if size := len(e.G); size != 512 {
	...
	// Field (1) 'P'
	if size := len(e.P); size != 512 {
		err = ssz.ErrBytesLengthFn("--.P", size, 512)
		return
	}
	dst = append(dst, e.P...)

	// Field (2) 'Y'
	if size := len(e.Y); size != 512 {
...
// UnmarshalSSZ ssz unmarshals the ElgamalPublicKey object
func (e *ElgamalPublicKey) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 1536 {
		return ssz.ErrSize
	...
	// Field (0) 'G'
	if cap(e.G) == 0 {
		e.G = make([]byte, 0, len(buf[0:512]))
	}
	e.G = append(e.G, buf[0:512]...)

	// Field (1) 'P'
	if cap(e.P) == 0 {
		e.P = make([]byte, 0, len(buf[512:1024]))
	}
	e.P = append(e.P, buf[512:1024]...)

	// Field (2) 'Y'
	if cap(e.Y) == 0 {
		e.Y = make([]byte, 0, len(buf[1024:1536]))
	}
	e.Y = append(e.Y, buf[1024:1536]...)

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ElgamalPublicKey object
func (e *ElgamalPublicKey) SizeSSZ() (size int) {
	size = 1536
	return
}

// HashTreeRoot ssz hashes the ElgamalPublicKey object
func (e *ElgamalPublicKey) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ElgamalPublicKey object with a hasher
func (e *ElgamalPublicKey) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the ElgamalPrivateKey object
func (e *ElgamalPrivateKey) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ElgamalPrivateKey object to a target array
func (e *ElgamalPrivateKey) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'PublicKey'
	if e.PublicKey == nil {
		e.PublicKey = new(ElgamalPublicKey)
	}
	if dst, err = e.PublicKey.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (1) 'X'
	if size := len(e.X); size != 512 {
		err = ssz.ErrBytesLengthFn("--.X", size, 512)
		return
	}
	dst = append(dst, e.X...)
...
// UnmarshalSSZ ssz unmarshals the ElgamalPrivateKey object
func (e *ElgamalPrivateKey) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 2048 {
		return ssz.ErrSize
	...
	if err = e.PublicKey.UnmarshalSSZ(buf[0:1536]); err != nil {
		return err
	}

	// Field (1) 'X'
	if cap(e.X) == 0 {
		e.X = make([]byte, 0, len(buf[1536:2048]))
	}
	e.X = append(e.X, buf[1536:2048]...)

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ElgamalPrivateKey object
func (e *ElgamalPrivateKey) SizeSSZ() (size int) {
	size = 2048
	return
}

// HashTreeRoot ssz hashes the ElgamalPrivateKey object
func (e *ElgamalPrivateKey) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ElgamalPrivateKey object with a hasher
func (e *ElgamalPrivateKey) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'PublicKey'
	if err = e.PublicKey.HashTreeRootWith(hh); err != nil {
		return
	}
